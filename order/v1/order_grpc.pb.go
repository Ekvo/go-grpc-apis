...
const (
	OrderService_NewOrder_FullMethodName    = "/order.v1.OrderService/NewOrder"
...
type OrderServiceClient interface {
	NewOrder(ctx context.Context, in *CreateOrderRequest, opts ...grpc.CallOption) (*CreateOrderResponse, error)
...
func (c *orderServiceClient) NewOrder(ctx context.Context, in *CreateOrderRequest, opts ...grpc.CallOption) (*CreateOrderResponse, error) {
...
type OrderServiceServer interface {
	NewOrder(context.Context, *CreateOrderRequest) (*CreateOrderResponse, error)
...
func (UnimplementedOrderServiceServer) NewOrder(context.Context, *CreateOrderRequest) (*CreateOrderResponse, error) {
...
func _OrderService_NewOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).NewOrder(ctx, req.(*CreateOrderRequest))
	}
